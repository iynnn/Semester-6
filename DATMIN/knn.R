...
# ini itu di tunning 
# syntaXNYA BISA BERUPA LOOPING, dengan k = 3 sampai dengan 21 itu bisa MISALNYA DI AKHIR, KALAU BAPAKNYA BILANG KATA NIKO JUGA, HARUS DITULIS MISAL 
...
i=1
k.optm=1
for (i in 1:28){ # KALO BAPAKNYA MAKE BY = 2
